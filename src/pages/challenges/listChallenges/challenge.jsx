...
import challengesData from './challenges.json'; // Importing the JSON data directly

const Challenge = ({ challenge }) => {
  const isOngoing = challenge.status === 'Ongoing';

  return (
    <div className="max-w-xs rounded overflow-hidden shadow-lg my-2 relative hover:shadow-xl h-full">
      <img 
