                ...
                <form>
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input id="password" type="password" className="form-input w-full text-gray-800" placeholder="Enter your password address" required />
                    </div>
                  </div>
                  <div className="flex flex-wrap -mx-3 mt-6">
                    <div className="w-full px-3">
                      <button className="btn text-white bg-blue-600 hover:bg-blue-700 w-full">Send link</button>
                    </div>
                  </div>
                </form>
              </div>
