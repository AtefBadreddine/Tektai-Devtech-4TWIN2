...
export default function StepThree({ formData, handleInput, handleNext, handlePrevious }) {
    ...
    const submit = async () => {
        ...
        if (response.statusCode === 201) {
            ...
            return (
                <div className="">
                    <h1 className="h2 text-red-600 pb-4">An Error Occurred ! </h1>
                    <div className="inline-flex gap-x-2">You will be redirected to the home page in a few seconds.</div>
                </div>
            );
        }
    };
    ...
    const handleBack = (e) => {
        e.preventDefault();
        handlePrevious(); // Call the handlePrevious function to go back to Step Two
    };
    ...
    if (formData.role === 'challenger' || submitted === true) {
        return (
            <div className="">
                ...
                <div className="inline-flex gap-x-2">You will be redirected to the challenges page in a few seconds.
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="flex flex-wrap -mx-3 mb-4">
                        <div className="w-full px-3">
                            ...
                            <input id="adresse" type="text" name="adresse" onChange={handleInput} className="form-input w-full text-gray-800" placeholder="Enter your legal address" required />
                        </div>
                    </div>
