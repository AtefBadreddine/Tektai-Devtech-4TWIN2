...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[20vh]  flex flex-col items-center py-0 md:py-32 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
