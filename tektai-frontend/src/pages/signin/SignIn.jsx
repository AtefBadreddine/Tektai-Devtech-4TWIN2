...
function SignIn() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!captchaValid && process.env.NODE_ENV === 'development') {
          ...
          <button className="btn text-white bg-blue-600 hover:bg-blue-700 w-full mt-4">Sign in</button>
                    ...
                    <form>
                      <div className="flex flex-wrap -mx-3 mb-3">
                        <div className="w-full px-3">
                          <a href="${API_URL}/auth/github" rel='noopener noreferrer' target="_self"  className="btn px-0 text-white text-center bg-gray-900 hover:bg-gray-800 w-full relative flex items-center">
                      ...
                      <div className="flex flex-wrap -mx-3">
                        <div className="w-full px-3">
                          <a href="${API_URL}/auth/google" rel='noopener noreferrer' target="_self" className="text-center btn px-0 text-white bg-red-600 hover:bg-red-700 w-full relative flex items-center">
                            <svg className="w-4 h-4 fill-current text-white opacity-75 flex-shrink-0 mx-4" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
