...
const Profile: React.FC = () => {
 ...
 <div className="mr-4 p-3 text-center flex items-center"> {/* Added flex and items-center */}
  <Link to="/challenges/new">
    <button className="bg-gray-300 hover:bg-gray-400 text-gray-800 hover:text-gray-100 font-bold py-2 px-3 rounded-l hover:shadow-md shadow text-xs flex items-center"> {/* Added flex and items-center */}
