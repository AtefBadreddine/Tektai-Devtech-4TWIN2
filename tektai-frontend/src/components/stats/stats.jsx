...
function Stats() {
  ...
  className="my-4 w-full sm:w-auto p-2 rounded-md border border-gray-300 focus:outline-none focus:ring focus:ring-blue-400 bg-white dark:bg-gray-800 text-gray-800 dark:text-white shadow-md"
>
      ...
      <div className="flex flex-wrap justify-center">
        {/* <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-2">
          <a href="https://github.com/vn7n24fzkq/github-profile-summary-cards">
            <img src={`https://raw.githubusercontent.com/Armi64bit/armi64bit/master/profile-summary-card-output/${theme}/0-profile-details.svg`} alt="Profile Details" className="w-full h-auto" />
          </a>
        </div> */}
        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-2">
          <a href="https://github.com/vn7n24fzkq/github-profile-summary-cards">
