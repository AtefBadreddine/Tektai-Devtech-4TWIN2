    ...
    return (
      <>
            <head>
                ...
                <script src="https://cdn.jsdelivr.net/npm/@alpinejs/intersect@3.x.x/dist/cdn.min.js" defer />
                    ...
                    <div className="w-full max-w-5xl mx-auto px-4 md:px-6 py-24">
                        <section className="grid gap-12 md:grid-cols-3 md:gap-16">
                            <article>
                                ...
                                <h2>
                                    <span className={`flex tabular-nums text-slate-900 text-5xl font-extrabold mb-2 transition-[_--num] duration-[3s] ease-out [counter-set:_num_var(--num)] supports-[counter-set]:before:content-[counter(num)] ${shown ? '[--num:40]' : ''}`}>
