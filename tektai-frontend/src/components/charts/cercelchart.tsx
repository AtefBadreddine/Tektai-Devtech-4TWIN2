...
const Chartcercle: React.FC = () => {
  ...
  const [state, setState] = useState({
    series: [
      {
        data: [userData.gpts, userData.spts, userData.bpts],
      },
    ],
  });
        ...
        <div id="chartThree" className="mx-auto flex justify-center">
          <ReactApexChart
            options={{
              ...
              colors: ['#3C50E0', '#6577F3', '#8FD0EF'], // Adjusting colors to match ChartOne
            }}
            series={[
              {
                name: 'Visitors',
